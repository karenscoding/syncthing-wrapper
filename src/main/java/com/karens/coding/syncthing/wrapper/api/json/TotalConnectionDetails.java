...
public class TotalConnectionDetails implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -5942548117230242827L;
	...
	public String toString() {
		...
		builder.append("TotalConnectionDetails [paused=").append(paused).append(", clientVersion=").append(clientVersion).append(", at=").append(at).append(", connected=")
				.append(connected).append(", inBytesTotal=").append(inBytesTotal).append(", type=").append(type).append(", outBytesTotal=").append(outBytesTotal)
